      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-8">
            ...
            according to your skills and interests. The opportunities with the
            highest match percentage are being shown first.
          </p>
        ...
        <div className="bg-white rounded-2xl p-6 md:p-8 mb-12 shadow-md border border-orange-200">
          ...
          <div className="text-center mt-6">
            <p className="text-gray-600">
              ...
              Based on your profile, you have excellent chances in Government
              and Technology sectors. आपके skills perfect match कर रहे हैं!
            </p>
          </div>
        </div>
